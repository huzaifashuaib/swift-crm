...
const MonthlyIncome = () => {
  ...
  return (
      ...
      <div className="bg-white py-5 px-[14px] md:py-6 md:px-4 rounded-[10.5px] border-custom border-custom-border-color h-full">
